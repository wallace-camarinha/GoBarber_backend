...
let SendRecoveryPasswordEmailService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    const passwordRecoveryTemplateFile = _path.default.resolve(__dirname, '..', 'views', 'password_recovery.hbs');
...
var _default = SendRecoveryPasswordEmailService;
